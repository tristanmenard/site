...
(function($) {
  ...
  function Plugin(element, options) {
    ...
    this.configObsAttributes = [{"field":"COMMENT_OBS","label":""},{"field":"COMMENT_OBS_0","label":"*"},{"field":"COMMENT_OBS_1","label":"e"}];
...
function nonFieldColumns() {
  ...
  var observationAttributes = [{"field":"COMMENT_OBS","label":""},{"field":"COMMENT_OBS_0","label":"*"},{"field":"COMMENT_OBS_1","label":"e"}];
  if (observationAttributes && observationAttributes.length > 0) {
...
function prepareDataForDataset(years, rows, allObservationAttributes) {
  ...
  var configObsAttributes = [{"field":"COMMENT_OBS","label":""},{"field":"COMMENT_OBS_0","label":"*"},{"field":"COMMENT_OBS_1","label":"e"}];
...
function inputEdges(edges) {
  ...
  var configuredObservationAttributes = [{"field":"COMMENT_OBS","label":""},{"field":"COMMENT_OBS_0","label":"*"},{"field":"COMMENT_OBS_1","label":"e"}];
...
function getAllObservationAttributes(rows) {
  ...
  var obsAttributeHash = {},
      footnoteNumber = 0,
      configObsAttributes = [{"field":"COMMENT_OBS","label":""},{"field":"COMMENT_OBS_0","label":"*"},{"field":"COMMENT_OBS_1","label":"e"}];
  if (configObsAttributes && configObsAttributes.length > 0) {
    configObsAttributes = configObsAttributes.map(function(obsAtt) {
      return obsAtt.field;
    });
...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues, proxy, proxySerieses, allObservationAttributes) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"disaggregation_controls":false,"minZoom":2,"maxZoom":6,"tileURL":"https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png","tileOptions":{"id":"","accessToken":"","attribution":"OpenStreetMap"},"colorRange":"chroma.brewer.BuGn","noValueColor":"#f0f0f0","styleNormal":{"weight":1,"opacity":1,"fillOpacity":0.7,"color":"#888888","dashArray":""},"styleHighlighted":{"weight":1,"opacity":1,"fillOpacity":0.7,"color":"#111111","dashArray":""},"styleStatic":{"weight":2,"opacity":1,"fillOpacity":0,"color":"#172d44","dashArray":"5,5"}},
      mapLayers: [{"subfolder":"regions","label":"Regions","min_zoom":2,"max_zoom":6}],
      precision: precision,
...
function getObservationAttributeText(obsAttribute) {
    var configuredObsAttributes = [{"field":"COMMENT_OBS","label":""},{"field":"COMMENT_OBS_0","label":"*"},{"field":"COMMENT_OBS_1","label":"e"}];
